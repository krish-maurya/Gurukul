  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        display: ["var(--font-syne)", "Syne", "Inter", "system-ui", "sans-serif"],
      },
      boxShadow: {
        ...
        modal: "0 8px 30px rgba(15, 23, 42, 0.12), 0 4px 8px rgba(15, 23, 42, 0.06)",
      },
      borderRadius: {
        xl: "0.75rem",
        "2xl": "1rem",
      ...
      keyframes: {
        ...
        "tab-fade": { "0%": { opacity: "0", transform: "translateY(4px)" }, "100%": { opacity: "1", transform: "translateY(0)" } },
        shimmer: { "0%": { backgroundPosition: "-200% 0" }, "100%": { backgroundPosition: "200% 0" } },
        "check-pop": { "0%": { opacity: "0", transform: "scale(0.3)" }, "70%": { opacity: "1", transform: "scale(1.1)" }, "100%": { opacity: "1", transform: "scale(1)" } },
        "dot-bounce": { "0%, 60%, 100%": { transform: "translateY(0)", opacity: "0.4" }, "30%": { transform: "translateY(-4px)", opacity: "1" } },
        "pulse-ring": { "0%": { opacity: "0.8", transform: "scale(0.9)" }, "100%": { opacity: "0", transform: "scale(1.3)" } },
      },
      animation: {
