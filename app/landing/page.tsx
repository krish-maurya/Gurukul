...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white text-gurukul-ink font-sans">
      {/* Navigation Header */}
      <header className="border-b sticky top-0 z-50 bg-white" style={{ borderColor: "var(--line)" }}>
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs font-medium" style={{ color: "var(--muted)" }}>
            <a href="#features" className="transition-colors" style={{ color: "var(--muted)" }} onMouseEnter={(e) => e.currentTarget.style.color = "var(--ink)"} onMouseLeave={(e) => e.currentTarget.style.color = "var(--muted)"}>Features</a>
            <a href="#roles" className="transition-colors" style={{ color: "var(--muted)" }} onMouseEnter={(e) => e.currentTarget.style.color = "var(--ink)"} onMouseLeave={(e) => e.currentTarget.style.color = "var(--muted)"}>Roles</a>
            <a href="#copilot" className="transition-colors" style={{ color: "var(--muted)" }} onMouseEnter={(e) => e.currentTarget.style.color = "var(--ink)"} onMouseLeave={(e) => e.currentTarget.style.color = "var(--muted)"}>AI Copilot</a>
          </nav>
      ...
      <section className="pt-24 pb-20 px-6 relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] pointer-events-none" style={{ background: "radial-gradient(circle at 50% 50%, var(--accent-glow), transparent 60%)" }} />
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-gurukul-ink leading-[1.15]" style={{ fontFamily: "var(--font-syne)" }}>
            The intelligent way to
            <br />
            run your school
          </h1>

          <p className="mt-5 text-sm sm:text-base max-w-xl mx-auto leading-relaxed" style={{ color: "var(--muted)" }}>
      ...
      <section id="features" className="px-6 pb-20">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px rounded-xl overflow-hidden" style={{ background: "var(--line)" }}>
            {[
              {
                icon: UserCheck,
              ...
              >
                ...
                <h3 className="text-sm font-semibold text-gurukul-ink" style={{ fontFamily: "var(--font-syne)" }}>{feature.title}</h3>
      ...
      {/* Role Section */}
      <section id="roles" className="px-6 pb-20 py-20 border-y" style={{ background: "var(--soft)", borderColor: "var(--line)" }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-xl font-bold tracking-tight text-gurukul-ink" style={{ fontFamily: "var(--font-syne)" }}>Built for two roles</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={item.role} className="card p-6">
                ...
                <h3 className="text-base font-semibold text-gurukul-ink mt-3" style={{ fontFamily: "var(--font-syne)" }}>{item.role}</h3>
      ...
      {/* Footer */}
      <footer className="border-t py-8 px-6 bg-white" style={{ borderColor: "var(--line)" }}>
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between text-xs gap-3" style={{ color: "var(--faint)" }}>
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-gurukul-ink" style={{ fontFamily: "var(--font-syne)" }}>Gurukul</span>
          </div>
